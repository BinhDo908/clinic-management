...
|---------|-------------|-----------------|
| Quản trị viên | `ADMIN` | Toàn quyền, xem báo cáo doanh thu |
| Lễ tân | `RECEPTIONIST` | Tiếp nhận bệnh nhân, đặt lịch, duyệt lịch online, thu ngân |
| Bác sĩ | `DOCTOR` | Khám bệnh, ghi bệnh án, kê đơn thuốc |
| Dược sĩ / Thủ kho | `PHARMACIST` | Quản lý danh mục và tồn kho thuốc |
...
Truy cập `/login/`, đăng nhập bằng tài khoản được cấp. Sau khi đăng nhập, hệ thống tự
chuyển người dùng tới khu vực làm việc tương ứng với vai trò. Tài khoản do lễ tân tạo có
mật khẩu mặc định `123456` và bị bắt buộc đổi mật khẩu ở lần đăng nhập đầu tiên.
...
- Thêm, sửa, ẩn thuốc và **nhập thêm tồn kho**. Danh sách cảnh báo các thuốc sắp hết.

### Quản trị viên (`/cashier/dashboard/`)
...
Dự án có bộ kiểm thử tự động (end-to-end) cho các luồng nghiệp vụ chính. Chạy:
